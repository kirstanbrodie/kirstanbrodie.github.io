...
**Brodie, K.**, Schwitzgebel, E., Nemirow, J., & Cushman, F. (revise and resubmit). Philosophical arguments can boost charitable giving. [**Online**](https://osf.io/preprints/psyarxiv/5v2md_v1){target="_blank"} \| [**PDF**](files/papers/Charitable_Giving_Manuscript_Preprint.pdf)

#### [Peer-reviewed publications]{.underline}

Lee, R., **Brodie, K.**, Richardson, J., & Gilovich, T. (in press). Glad to help out: Grateful people are more likely to engage in costly prosocial action. *Emotion.* [**Online**](https://psycnet.apa.org/record/2028-15370-001){target="_blank"} \| [**PDF**](files/papers/LeeBrodieRichardsonGilovich2026.pdf)
